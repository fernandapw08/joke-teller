...
// Passing our Joke to VRSS API
function tellMe(joke) {
    VoiceRSS.speech({
        key: 'bdf65c8ab8564396980a208628d6b5d1',
        src: joke,
        hl: 'en-us',
        v: 'Linda',
        r: 0, 
...
async function getJokes() {
    let joke = '';
    const apiUrl = 'https://v2.jokeapi.dev/joke/Programming,Miscellaneous,Christmas?blacklistFlags=nsfw,religious,political,racist,sexist,explicit';
    try {
